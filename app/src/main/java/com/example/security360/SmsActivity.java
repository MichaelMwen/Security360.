...
public boolean onOptionsItemSelected(MenuItem item) {
    if (item.getItemId() == R.id.action_Detailed_instructions) {
        startActivity(new Intent(getApplicationContext(), SosInsructionsActivity.class));
        return true;
    } else if (item.getItemId() == R.id.action_Short_instructions) {
        ...
        return super.onOptionsItemSelected(item); // Fall back to default behavior
    }
}
