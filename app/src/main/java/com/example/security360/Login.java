...
import com.example.security360.R;
...
public class Login extends AppCompatActivity {
    ...
    private void handleLoginErrors(@NonNull Task<AuthResult> task) {
        // Check for specific authentication errors and log them
